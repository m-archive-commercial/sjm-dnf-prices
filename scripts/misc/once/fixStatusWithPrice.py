...
update500 = coll_product.update_many(
    ...
    {"$set": {FIELD_WITH_PRICE: STATUS.PASSED_FOR_INTERNAL_SERVER_ERROR}}
)

updateUnknown = coll_product.update_many(
    {FIELD_WITH_PRICE: STATUS.PASSED_FOR_KOREAN_ONLY},
    {"$set": {FIELD_WITH_PRICE: STATUS.UNKNOWN}}
)

updateKorean = coll_product.update_many(
    {"category.L1_name": "韩服独有"},
    {"$set": {FIELD_WITH_PRICE: STATUS.PASSED_FOR_KOREAN_ONLY}}
)
